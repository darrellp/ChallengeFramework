...
namespace MiscChallenges.Challenges
{
	public static partial class ChallengeClass
	{
        ...
        public static int HexCharToValue(this char ch)
        {
            // No argument checking here so be careful!
            ch = char.ToLower(ch);
            return char.IsLetter(ch) ? ch - 'a' + 10 : ch - '0';
        }
		...
		// Got the following from https://dlaa.me/blog/post/9380245.  Much faster than the standard
		// .Net MD5 implementation
